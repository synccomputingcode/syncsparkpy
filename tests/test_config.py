...
class TestConfig(unittest.TestCase):
    ...
    def test_set_api_key_when_api_key_exists_raises_an_error(self, mock_api_key):
        ...
        new_api_key = config.APIKey(
            api_key_id="mock_api_key_id_2", api_key_secret="mock_api_key_secret_2"
        )
    ...
    def test_set_databricks_config_when_db_config_exists_raises_an_error(self, mock_db_config):
        ...
        new_db_config = config.DatabricksConf(
            host="https://fakedbx-host-2.com", token="dsapifaketoken2", aws_region_name="us-east-2"
        )
